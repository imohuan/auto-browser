 ...
 */
export class NetworkStartDebuggerCaptureNode extends HttpFlowNode {
  ...
  async execute(inputs, execContext) {
    ...
    this.logger.debug("启动Debugger捕获", { viewId, options });

    return await this.invoke("network:startDebuggerCapture", viewId, options);
  }
}
